...
class WatchCycleService {
  ...
  Future<WatchCycleData?> getLatestCycleData() async {
    final result = await _channel.invokeMapMethod<String, dynamic>('getLatestCycleData');
    ...
    return WatchCycleData(
      periodStart: DateTime.fromMillisecondsSinceEpoch(result['period_start_ms'] as int),
